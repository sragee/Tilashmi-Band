      ...
      <Link href={`/news/${post.slug}`} className="group block overflow-hidden rounded-3xl glass">
        ...
        <div className="p-6">
          ...
          <h3 className="mt-2 font-display text-xl text-black flex items-start justify-between gap-2">
            {post.title}
            <ArrowUpRight size={18} className="mt-1 shrink-0 text-black/35 transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:text-black" />
          </h3>
