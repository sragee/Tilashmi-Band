    ...
    <aside className="w-full lg:w-64 shrink-0 border-b lg:border-b-0 lg:border-r border-black/8 bg-[#fafaf8]">
      <div className="lg:sticky lg:top-0 lg:h-screen flex flex-col">
        <div className="px-6 py-6 border-b border-black/8">
          ...
          <p className="text-xs text-black/40 mt-0.5">Admin Dashboard</p>
        </div>
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm transition-colors ${
                  active ? "bg-black/8 text-black" : "text-black/50 hover:text-black hover:bg-black/5"
                }`}
              >
        ...
        <div className="px-3 py-4 border-t border-black/8 space-y-1">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-black/50 hover:text-black hover:bg-black/5"
          >
            <ExternalLink size={16} /> View Site
          </a>
          <button
            onClick={logout}
            className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-black/50 hover:text-red-500 hover:bg-black/5"
          >
